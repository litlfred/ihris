...
2. **Where the IG lives.** A DAK IG in this repo (`src/ihris-data-dictionary`), contributions to `iHRIS/iHRIS` (the iHRIS 5 IG, canonical `http://ihris.org/fhir`), or both.
