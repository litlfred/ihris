...
shippedIn:
  - ihris-qualify/modules/qualify-help/static/help/ihris_add_disciplinary_action_information.html
  - ihris-qualify/modules/qualify-help/static/help/ihris_understanding_ihris_manage.html
  - ihris-qualify/modules/qualify-help/static/help/ihris_understanding_ihris_manage_4.0.html
...
New features and development are ongoing. As this is an Open Source development project, volunteers and other organizations may also contribute to the core code. Check the iHRIS Manage page (http://www.capacityproject.org/hris/suite/ihris\_manage.php) on the HRIS Strengthening Website for the most up-to-date list of planned features and a development calendar.
