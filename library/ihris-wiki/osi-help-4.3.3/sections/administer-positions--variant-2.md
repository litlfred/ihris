...
shippedIn:
  - ihris-manage/modules/manage-help/static/help/ihris_administer_positions_4.0.html
  - ihris-qualify/modules/qualify-help/static/help/ihris_administer_positions_4.0.html
...
The supervisor's position must be added to the system before it can be selected. Repeat these steps to add the supervisor's position, then edit the current position to select the correct supervisor (see [Edit a position](ihris_administer_positions.html#Edit_a_Position "Administer Positions")).
...
The salary source must be added to the system by an HR Manager (see [Add salary sources](ihris_administer_positions.html#Add_Salary_Sources "Administer Positions")).
...
The position type must be added to the system by an HR Manager (see [Add position types](ihris_administer_positions.html#Add_Position_Types "Administer Positions")).
