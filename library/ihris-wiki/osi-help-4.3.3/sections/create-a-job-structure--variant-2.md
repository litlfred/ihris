...
shippedIn:
  - ihris-manage/modules/manage-help/static/help/ihris_create_a_job_structure_4.0.html
  - ihris-qualify/modules/qualify-help/static/help/ihris_create_a_job_structure_4.0.html
...
The salary grade must be added to the system before adding the job (see [Add salary grades](ihris_create_a_job_structure.html#Add_Salary_Grades "Create a Job Structure")).

**The correct cadre is not available for selection.**

The cadre must be added to the system before adding the job (see [Add cadres](ihris_create_a_job_structure.html#Add_Cadres "Create a Job Structure")).

**The correct classification is not available for selection.**

The job classification must be added to the system before adding the job (see [Add job classifications](ihris_create_a_job_structure.html#Add_Job_Classifications "Create a Job Structure")).
