---
title: "Technical Overview: Form Storage -- SDMX-HD"
source: http://open.intrahealth.org/w/index.php?oldid=33553
...
This is a read-only form storage mechanism. This storage mechanism will only work for forms that are or extend I2CE\_SimpleList.
...
To use SDMX-HD storage for a form use the following configuration. Replace $form, $form\_name, $file\_location and $CL\_ID with the appropriate values.
