---
title: "Managing A Site In Launchpad"
source: http://open.intrahealth.org/w/index.php?oldid=33706
...
This tutorial will take you through the steps of managing a site via bazaar on Launchpad based on some customizations that you have already made on your Ubuntu machine for the the version 4.0 of iHRIS Qualify for the Nursing and Midwives Council.
...
First you should create an account on Launchpad \[1\]. If you not have already done so, you can find some help here \[1\].

We will refer to this account as LAUNCHPAD\_USER.
...
- Browse to the launchpad homepage \[1\]

- Select "Register a Team"

- For the Name I suggest something like ihris-COUNTRY\_NAME or ihris-ORGANIZATION\_NAME
- For the Display Name you can use something like iHRIS in COUNTRY\_NAME
- For the Subscription policy, I suggest making it "Open"

Once the team is created, you can choose view its home page at

```
 https://www.launchpad.net/~ihris-COUNTRY_NAME
```
...
Since we will want to contribute to the code, we need to let Launchpad know who are. To do this, we create a ssh public key \[2\] on your Ubuntu machine to add to Launchpad:
...
- Name is ihris+nmc+COUNTRY\_NAME
- Title is iHRIS Qualify for NMC in COUNTRY\_NAME
- Summary is Implementation of iHRIS Qualify for the Nursing and Midwifery Council of COUNTRY\_NAME
- Step 2
...
```
https://edge.launchpad.net/ihris+nmc+COUNTRY_NAME
```

From the project home page you can:

- Change the Maintainer by clicking the exclamation point yellow circle next to "Maintainer". You should set it to be the team ihris-COUNTRY\_NAME that you created above
...
```
https://code.launchpad.net/ihris+nmc+COUNTRY_NAME
```
...
- For the owner, make sure it is the team we created above ihris-COUNTRY\_NAME
...
```
https://code.edge.launchpad.net/~ihris-COUNTRY_NAME/ihris+nmc+COUNTRY_NAME/NMC-4.0
```
...
- The branch to be: ~ihris-COUNTRY\_NAME/ihris+nmc+COUNTRY\_NAME/NMC-4.0
...
\[1\] https://help.launchpad.net/YourAccount/NewAccount
