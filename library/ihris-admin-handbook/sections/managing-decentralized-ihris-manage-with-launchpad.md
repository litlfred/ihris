---
title: "Managing Decentralized iHRIS Manage with Launchpad"
source: http://open.intrahealth.org/w/index.php?oldid=33671
contributors: ["Litlfred"]
pages: 482-483
licence: GFDL-1.2
capturedFrom: uploads/ihris-admin-handbook/ihris_admin_handbook_sep_17_2010.pdf
---
# Managing Decentralized iHRIS Manage with Launchpad
...
- At the national level, the facility data needs to be componentized by regions and the facility and facility\_contact forms will use the (read-only) multi-flat storage mechanism to aggregate the cached data tables from the regional level.
...
- At the district level, the facility and facility contact data is exported from the region within two modules: ihris-manage-taifeki-northern-region-facility and ihris-manage-taifeki-northern-region-facility\_contact. You would choose to use (read-only) magic data form storage mechanism in your data policy.
