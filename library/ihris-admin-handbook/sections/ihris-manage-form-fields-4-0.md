...
source: http://open.intrahealth.org/w/index.php?oldid=34900
...
The form contact is implemented by the class: iHRIS\_Contact It has the following fields:
...
The form employee\_status is implemented by the class: I2CE\_SimpleList It has the following fields:
...
The form job is implemented by the class: iHRIS\_Job It has the following fields:
...
The form role is implemented by the class: I2CE\_Role It has the following fields:
...
The form user is implemented by the class: I2CE\_User\_Form It has the following fields:
...
\[1\] http://open.intrahealth.org/visualizations/forms-ihris-manage-site-demo\_4\_0\_1.gif
