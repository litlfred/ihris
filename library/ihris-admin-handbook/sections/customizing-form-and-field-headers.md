---
title: "Customizing Form and Field Headers"
source: http://open.intrahealth.org/w/index.php?oldid=31085
...
```
<configuration name="custom_headers" path="/modules/forms/formClasses/$formClass/fields/$
...
```
<configuration name="region_header" path="/modules/forms/formClasses/iHRIS_District/field
  <value>State</value>
</configuration>
```
...
```
<configuration name="form_display" path="/modules/forms/forms/$form/display" locale="en_U
  <value>$newHeader</value>
</configuration>
```
...
```
<configuration name="region_display" path="/modules/forms/forms/region/display" locale="e
  <value>State</value>
</configuration>
```
...
Here's a complete example that you can add to your site's configuration .xml file. It will change the names of the levels of geography to be Country/State/Council/Town or City. Country will stay the same, region will become State, district will become Council and county will be come Town or City. You will need to change the &lt;version&gt;4.0.XXX&lt;/version&gt; as appropriate (see versions).
...
<configurationGroup name="forms_module" path="/modules/forms">
  ...
  <configurationGroup name="formClasses">
    <configuration name="district_region_header" path="iHRIS_District/fields/region/heade
      <value>State</value>
    </configuration>
    <configuration name="country_district_header" path="iHRIS_County/fields/district/head
      <value>Council</value>
    </configuration>
  </configurationGroup>
</configurationGroup>
...
where you replace 4.0.4 with the appropriate version and my\_site the name of the directory that your site is stored in.

Once gedit appears, you will need to change the names of the forms. For example:

```
  <li task="can_edit_database_list_county"><a href="lists?type=county&amp;field=district"
```
