---
title: "Upgrading From 3.1"
source: http://open.intrahealth.org/w/index.php?oldid=4158
contributors: ["Lduncan", "Litlfred", "MarkAHershberger", "Mnamutso"]
pages: 525-527
licence: GFDL-1.2
...
You can either get the released or the development code. Suppose that \[base\_path\] is the directory which contains i2ce, common, manage etc.

### Backup Database

We should back up the database. Go into phpmyadmin, select your database, click on operations, and copy the database to a new name \[database\_name\].
...
- set the $i2ce\_site\_database to \[database\_name\], the name of the new database
- set $i2ce\_site\_i2ce\_path to \[base\_path\]/i2ce, the directory where the new version of I2CE is located
