---
title: "Swiss Magic Data -- Form Relationships"
source: http://open.intrahealth.org/w/index.php?oldid=4498
...
In this article we over view the swiss magic structure used to create the web interface to define form relationships. Recall that a swiss node of type XXX is implemented by the class I2CE\_Swiss\_XXX. All the classes mentioned are contained in the
...
- 'reporting\_functions' with type #FormRelationship\_ReportingFunctions
- 'joins' with type #FormRelationship\_Joins
- 'where' #FormRelationship\_Where

## FormRelationship\_Joins
...
All children of this swiss node have type #FormRelationship\_Join.

## FormRelationship\_Join
...
- It allows you to "drop empty rows." Note: The language should be cleaned up here as we use form relationships outside of the Custom
...
There is one child swiss node 'operands' which has type #FormRelationship\_Where\_Operands

Note: The functionality of this swiss node should probably be moved to a sub-module of the FormLimits modules

## FormRelationship\_Where\_Operands
...
All children of this node are of type #FormRelationship\_Where

Note: The functionality of this swiss node should probably be moved to a sub-module of the FormLimits modules

## FormRelationship\_ReportingFunctions
...
All children of this node have type #FormRelationship\_ReportingFunctions.
...
- choose the return type of the SQL function to be any of the (non-abstract) subclasses of I2CE\_FormField.
